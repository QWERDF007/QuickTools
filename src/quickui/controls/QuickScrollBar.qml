...
T.ScrollBar {
    ...
    QuickTextIconButton{
        ...
        iconSource: QuickFontIcon.CaretLeftSolid8
        onClicked: {
            control.decrease()
        }
    }
    QuickTextIconButton{
        ...
        visible: control.horizontal
        iconSource: QuickFontIcon.CaretRightSolid8
        onClicked: {
            control.increase()
        }
    }
    QuickTextIconButton{
        ...
        iconSource: QuickFontIcon.CaretUpSolid8
        onClicked: {
            control.decrease()
        }
    }
    QuickTextIconButton{
        ...
        visible: control.vertical
        iconSource: QuickFontIcon.CaretDownSolid8
        onClicked: {
            control.increase()
        }
    }
