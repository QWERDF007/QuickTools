        ...
        property Component fluent_sytle:  Rectangle{
            ...
            Row{
                ...
                QuickTextIcon {
                    iconSource:{
                        switch(_super.type){
                        case mcontrol.const_success: return QuickFontIcon.CompletedSolid;
                        case mcontrol.const_warning: return QuickFontIcon.InfoSolid;
                        case mcontrol.const_info:    return QuickFontIcon.InfoSolid;
                        case mcontrol.const_error:   return QuickFontIcon.StatusErrorFull;
                        }
                        return QuickFontIcon.FA_info_circle
                    }
                    iconSize:20
                    iconColor: {
                        switch(_super.type){
                ...
                QuickTextIconButton {
                    id:btn_close
                    iconSource: QuickFontIcon.ChromeClose
                    iconSize: 10
                    y:5
